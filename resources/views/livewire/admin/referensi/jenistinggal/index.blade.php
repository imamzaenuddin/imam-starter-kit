...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    {
        if (! auth()->user()?->bisaMenu('/admin/referensi/jenistinggal', 'dapat_buat')) abort(403);
    ...
    {
        if (! auth()->user()?->bisaMenu('/admin/referensi/jenistinggal', 'dapat_ubah')) abort(403);
    ...
    {
        if (! auth()->user()?->bisaMenu('/admin/referensi/jenistinggal', 'dapat_hapus')) abort(403);
