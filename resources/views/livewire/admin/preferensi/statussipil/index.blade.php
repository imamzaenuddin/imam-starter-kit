...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    {
        if (! auth()->user()?->bisaMenu('/admin/preferensi/statussipil', 'dapat_buat')) abort(403);
    ...
    {
        if (! auth()->user()?->bisaMenu('/admin/preferensi/statussipil', 'dapat_ubah')) abort(403);
    ...
    {
        if (! auth()->user()?->bisaMenu('/admin/preferensi/statussipil', 'dapat_hapus')) abort(403);
